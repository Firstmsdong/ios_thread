 ...
 */
static const NSInteger MXTabBarItemCount = 3;
...
- (void)layoutSubviews
{
    ...
    CGRect centerButtonRect = CGRectZero;
        ...
        centerButtonRect.size.height = barHeight-30;
        centerButtonRect.size.width =barHeight-30;
    ...
    for (UIView *subview in self.subviews) {
        ...
        if (itemIndex >= 3) itemX += itemWidth; //右边的两个按钮
